...
<div>
	<main class="mx-auto my-0 max-w-2xl">
		...
		{#if stylesheets.stylesheets.length > 0 && fonts.families.length > 0}
			<p
				class="mb-4 rounded-md border border-red-900 bg-red-100 p-2 text-red-900"
			>
				Keep in mind, since you've already installed fonts, you'll be
				overwriting what you previously worked on.
				<strong>
